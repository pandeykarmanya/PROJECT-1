...
const RegisterForm = () => {
    ...
    return (
      <div className="w-full">
        ...
        <form onSubmit={handleOTPSubmit} className="space-y-6">
          <div className="form-group">
            ...
            <input
              ...
              required
              maxLength="6"
              className="w-full bg-white border border-gray-300 rounded-md px-4 py-3 text-orange-600 text-center text-2xl font-mono tracking-widest focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent placeholder-gray-800"
              placeholder="000000"
            />
          </div>
          ...
          <button
            type="submit"
            className="w-full bg-orange-600 hover:bg-orange-700 text-white py-3 rounded-md transition-colors flex items-center justify-center"
        ...
        <div className="mt-6 text-center">
          <p className="text-orange-500 mb-2">Didn't receive the OTP?</p>
          <button
  ...
  return (
    <div className="w-full">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="form-group">
          ...
          <input
            ...
            required
            className="w-full bg-white border border-gray-300 rounded-md px-4 py-2 text-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent placeholder-gray-800"
        ...
        <div className="form-group">
          <label htmlFor="role" className="block text-gray-800 mb-2">
            Role
          </label>
          <select
            id="role"
            ...
            value={formData.role}
            onChange={handleChange}
            className="w-full bg-white border border-gray-300 rounded-md px-4 py-2 text-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent"
          >
      ...
      <div className="mt-6 text-center text-orange-500">
